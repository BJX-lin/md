...
GS = os.path.join(GAME, "autoload", "game_state.gd")
...
KNOWN_FX = {
    ...
    "bloodhand", "bloodsmear", "blooddrip", "bloodedge", "bloodcrack", "cleanblood",
}
KNOWN_BG = {
    ...
    "prop", "desk", "rooftop", "stairwell", "infirmary", "schoolgate", "oldbuilding_class", "photo_wall", "keyboard",
    "monitor_room", "mirror",
}
ENDINGS = {
