...
## 每章会用到的背景文件名（不含扩展名）
const CHAPTER_BG := {
	0: ["keyvisual_school_rain", "title_school"],
	1: ["canteen_day", "classroom_day", "classroom_evening",
		"classroom_evening_alllook", "classroom_window_reflection", "desk_carving_shen",
		"dorm_307_day", "dorm_307_night_shadow", "dorm_door_gap_shadows",
		"dorm_door_night", "hallway_day", "hallway_dusk",
		"keyvisual_school_rain", "library_dim", "office_day",
		"prop_broadcast_register", "prop_duty_roster", "prop_library_card",
		"prop_missing_poster", "prop_pencil_case", "title_school"],
	2: ["broadcast_door_lightline", "broadcast_room_emptyseat", "classroom_day",
		"dorm_307_night_shadow", "dorm_corridor_night", "duty_room",
		"duty_room_day", "hallway_day", "hallway_night_flicker",
		"infirmary_day", "library_stacks_night", "office_day",
		"old_building_classroom", "old_building_gate_rain", "old_building_stairs",
		"oldbuilding_out_night", "prop_torn_page", "schoolyard_night",
		"stairwell_night", "title_school", "washroom_night"],
	3: ["classroom_evening", "dorm_307_night_namewall", "dorm_307_night_shadow",
		"dorm_door_night", "hallway_dusk", "hallway_night",
		"mirror_dark", "prop_bus_ticket", "prop_duty_roster",
		"prop_library_card", "prop_missing_poster", "rooftop_night"],
	4: ["archive_inner_door", "campus_rain", "classroom_day",
		"classroom_evening_alllook", "classroom_morning", "duty_room",
		"duty_room_keyboard", "graduation_photo_wall", "hallway_day",
		"history_hall_dusk", "monitor_room", "office_night",
		"prop_logbook", "prop_notice_board", "prop_roster_core",
		"prop_videotapes", "school_history_hall"],
	5: ["broadcast_door_lightline", "broadcast_room_emptyseat", "broadcast_room_fireedge",
		"broadcast_room_white", "broadcast_shenhe_back", "classroom_evening_alllook",
		"office_day", "old_building_gate_rain", "old_building_stairs",
		"oldbuilding_out_night", "school_history_hall", "title_school"],
}
