...
const CHAPTER_BG := {
	...
	2: ["broadcast_door_lightline", "broadcast_room_emptyseat", "classroom_day",
		...
		"duty_room_day", "hallway_day", "library_stacks_night",
		"office_day", "old_building_classroom", "old_building_gate_rain",
		"old_building_stairs", "oldbuilding_out_night", "prop_torn_page",
		"schoolyard_night", "title_school", "washroom_night"],
	...
	4: ["archive_inner_door", "campus_rain", "classroom_day",
		"classroom_evening_alllook", "duty_room", "duty_room_keyboard",
		"graduation_photo_wall", "hallway_day", "history_hall_dusk",
		"monitor_room", "office_night", "prop_logbook",
		"prop_notice_board", "prop_roster_core", "prop_videotapes",
		"school_history_hall"],
	5: ["broadcast_door_lightline", "broadcast_room_emptyseat", "broadcast_room_fireedge",
		"broadcast_shenhe_back", "classroom_evening_alllook", "office_day",
		"old_building_gate_rain", "old_building_stairs", "oldbuilding_out_night",
		"school_history_hall", "title_school"],
}
