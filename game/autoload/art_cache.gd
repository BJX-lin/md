...
const CHAPTER_BG := {
	...
	3: ["dorm_307_night_shadow", "dorm_door_night", "hallway_night",
		"mirror_dark", "prop_bus_ticket", "rooftop_night"],
	4: ["archive_inner_door", "campus_rain", "classroom_evening_alllook",
		...
		"prop_roster_core", "prop_videotapes", "school_history_hall"],
...
const CHAPTER_CHARS := {
	...
	3: ["liangye", "oldqin", "shenhe", "zhouxu"],
