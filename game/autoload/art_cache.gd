...
const CHAPTER_BG := {
	...
	1: ["canteen_day", "classroom_day", "classroom_evening",
		"classroom_evening_alllook", "dorm_307_day", "dorm_307_night_shadow",
		"dorm_door_night", "hallway_day", "hallway_dusk",
		"library_dim", "office_day", "title_school"],
	2: ["broadcast_door_lightline", "broadcast_room_emptyseat", "classroom_day",
		"dorm_307_night_shadow", "dorm_corridor_night", "duty_room",
		"duty_room_day", "hallway_day", "library_day",
		"office_day", "old_building_gate_rain", "old_building_stairs",
		"oldbuilding_out_night", "schoolyard_night", "title_school",
		"washroom_night"],
	3: ["dorm_307_night_shadow", "dorm_door_night", "hallway_night",
		"mirror_dark", "schoolyard_night"],
	4: ["archive_inner_door", "campus_rain", "classroom_evening_alllook",
		"duty_room", "history_hall_dusk", "monitor_room",
		"office_night", "school_history_hall"],
	5: ["broadcast_door_lightline", "broadcast_room_emptyseat", "broadcast_room_fireedge",
		"classroom_evening_alllook", "office_day", "old_building_gate_rain",
		"old_building_stairs", "oldbuilding_out_night", "school_history_hall",
		"title_school"],
}
