...
## 每章会用到的背景文件名（不含扩展名）
const CHAPTER_BG := {
	0: ["keyvisual_school_rain", "office_day"],
	1: ["canteen_day", "classroom_day", "classroom_evening",
		...
		"hallway_dusk", "library_dim", "office_day",
		"prop_broadcast_register", "prop_duty_roster", "prop_library_card",
		"prop_missing_poster", "prop_pencil_case", "title_school", "keyvisual_school_rain", "hallway_day_empty"],
	2: ["broadcast_door_lightline", "broadcast_room_dark", "classroom_day",
		...
		"hallway_night_flicker", "infirmary_day", "library_stacks_night",
		"office_day", "old_building_classroom", "old_building_gate_rain",
		"old_building_stairs", "oldbuilding_out_night", "prop_torn_page",
		"schoolyard_night", "stairwell_night", "title_school",
		"washroom_night", "library_stacks_dark", "stairwell_dark_descend"],
	3: ["classroom_evening", "dorm_307_deepnight", "dorm_307_night_namewall",
		...
		"rooftop_night", "washroom_night_mirror", "rooftop_door_night"],
