...
const CHAPTER_BG := {
	...
	3: ["classroom_evening", "dorm_307_night_shadow", "dorm_door_night",
		"hallway_dusk", "hallway_night", "mirror_dark",
		"prop_bus_ticket", "prop_duty_roster", "prop_library_card",
		"prop_missing_poster", "rooftop_night"],
